...
IF OBJECT_ID('Wishlist') IS NULL
	CREATE TABLE Wishlist
	(
	Id INT NOT NULL IDENTITY(1, 1) CONSTRAINT PK_Wish PRIMARY KEY,
...
EXEC USP_CreateFK 'FK_Wishlist_Products', 'Wishlist', 'IdProduct', 'Products', 'Id'
GO
